...
int main(int argc, const char * argv[]) {
    int a=0;
    int b=0;
    vector<int> sizes={10,100,1000,10000,100000, 2250000,2500000,2750000, 3000000,3250000,3500000, 3750000, 4000000,4250000,4500000, 4750000, 5000000, 6000000, 7000000,8000000,9000000, 10000000};
    for(int i=0;i<sizes.size();i++){
        Timer t;
        QunionFind l(sizes[i]);
        t.startTime();
        for(int j=0;j<100;j++){
